...
const users_all = [
    ...
    },
    {
        ...
        gender: 'Male',
        image_url: 'https://upload.wikimedia.org/wikipedia/en/c/cd/Dwight_Schrute.jpg',
        firstname: 'Dwight',
        lastname: 'Schrute',
        hobbies: [
            { name: 'Gym', rate: 5 },
    ...
    },
    {
        ...
        gender: 'Male',
        image_url: 'https://upload.wikimedia.org/wikipedia/en/8/84/Andy_Bernard_photoshot.jpg',
        firstname: 'Andy',
        lastname: 'Bernard',
        hobbies: [
            { name: 'Hiking', rate: 4 },
    ...
    },
    {
        ...
        gender: 'Male',
        image_url: 'https://upload.wikimedia.org/wikipedia/en/6/60/Office-1200-baumgartner1.jpg',
        firstname: 'Kevin',
        lastname: 'Malone',
    ...
    },
    {
        ...
        gender: 'Female',
        image_url: 'https://upload.wikimedia.org/wikipedia/en/0/0b/Angela_Martin.jpg',
        firstname: 'Angela',
        lastname: 'Martin',
    ...
    },
    {
        ...
        gender: 'Female',
        image_url: 'https://upload.wikimedia.org/wikipedia/en/6/69/Kelly_Kapoor.jpg',
        firstname: 'Kelly',
        lastname: 'Kapoor',
        hobbies: [
            { name: 'Chess', rate: 5 },
